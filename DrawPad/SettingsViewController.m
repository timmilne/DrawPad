...
- (void)viewDidLoad {
    ...
    [_brushControl setValue:brush];
    [_brushValueLabel setText:[NSString stringWithFormat:@"%f", brush]];
    [_opacityControl setValue:opacity];
    [_opacityValueLabel setText:[NSString stringWithFormat:@"%f", opacity]];
    
    // Jar the interface
    [self sliderChanged:_brushControl];
    [self sliderChanged:_opacityControl];
}
